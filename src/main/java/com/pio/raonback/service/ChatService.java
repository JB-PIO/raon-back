...
public interface ChatService {
  ...
  ResponseEntity<? super GetChatsResponseDto> getChats(Pageable pageable, RaonUser principal);

  ResponseEntity<? super GetChatResponseDto> getChat(Long chatId, RaonUser principal);

  ResponseEntity<? super GetMessagesResponseDto> getMessages(Long chatId, Pageable pageable, RaonUser principal);
