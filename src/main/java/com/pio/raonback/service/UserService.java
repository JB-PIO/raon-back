...
public interface UserService {
  ...
  ResponseEntity<? super UpdateNicknameResponseDto> updateNickname(UpdateNicknameRequestDto dto, CustomUserDetails userDetails);

  ResponseEntity<? super UpdateProfileImageResponseDto> updateProfileImage(UpdateProfileImageRequestDto dto, CustomUserDetails userDetails);
